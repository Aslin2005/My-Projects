...
initial begin
    for (f = 0; f < 3; f = f + 1) begin
        case (f)
            0: begin
                ...
                file_name_out = "verilog_optimized_950Hz.txt";
            end
            1: begin
                file_name_in  = "signal_1100Hz.txt";
                file_name_out = "verilog_optimized_1100Hz.txt";
            end
            2: begin
                file_name_in  = "signal_2000Hz.txt";
                file_name_out = "verilog_optimized_2000Hz.txt";
            end
        endcase
    ...
    $display("All Optimized Form simulations complete");
    $finish;
end
